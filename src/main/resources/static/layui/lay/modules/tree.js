...
;layui.define("form", function (e) {
    ...
    var i = layui.$, a = layui.form, n = layui.layer, t = "tree", r = {
        ...
        h = "layui-icon-add-circle", u = "layui-icon-reduce-circle", p = "layui-tree-entry", f = "layui-tree-main",
        ...
        layui.each(r, function (a, r) {
            var l = r.children && r.children.length > 0,
                ...
                h = i(['<div data-id="' + r.id + '" class="layui-tree-set' + (r.spread ? " layui-tree-spread" : "") + (r.checked ? " layui-tree-checkedFirst" : "") + '">', '<div class="layui-tree-entry">', '<div class="layui-tree-main">', function () {
                    return t.showLine ? l ? '<span class="layui-tree-iconClick layui-tree-icon"><i class="layui-icon ' + (r.spread ? "layui-icon-reduce-circle" : "layui-icon-add-circle") + '"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-icon layui-icon-subtraction"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-tree-iconArrow ' + (l ? "" : c) + '"></i></span>'
                }(), function () {
