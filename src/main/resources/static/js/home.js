...
function hide(){
    ...
    $('.layui-logo').html("<img src='/images/Logo.png' height='30'>")
...
function show(){
    $('.layuimini-tool-left').animate({left:'235px'});

    $('.layui-side cite').show();
    $('.layui-side').animate({width:'235px'});
    $('.layui-body').animate({left:'235px'});
    $('.layui-logo').html("<img src='/images/Logo.png' height='30'><cite>SuperHero</cite>");
    $('.layui-logo').animate({width:'235px'});
